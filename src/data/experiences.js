...
export const EXPERIENCES = {
  ...
  'indian-cities': {
    title: 'Indian Cities in Watercolor',
    icon: '🎨',
    contentType: 'Image',
    description: 'Indian cities reimagined as loose, luminous watercolor paintings — rooftops with water tanks and laundry lines, Varanasi ghats at dawn, Old Delhi bazaars, chai stalls, railway platforms, temple lanes. GPT-4 picks the scene and palette, gpt-image-2 paints it with wet-on-wet washes, visible brushstrokes, and bleeding color edges.',
    example: 'A watercolor of Mumbai rooftops at golden hour — ochre and burnt sienna washes, laundry lines, hazy amber sky dissolving into soft brushwork.',
  ...
  'hindu-temple-planet': {
    ...
    icon: '🛕',
    contentType: 'Image',
    description: 'Ancient Hindu temple worlds floating in black space — rendered in Disney Pixar 3D quality. GPT-4 conjures a new sacred scene every time: a South Indian gopuram glowing with diyas behind a bride and groom, a Kailasa cave temple with priests on stone steps, Hampi stone chariots with warriors, riverside ghats with pilgrims. Rich with marigold garlands, rangoli, brass lamps, palm trees. Every planet is a tiny world of devotion.',
    example: 'The Bridal Temple Planet — a Dravidian gopuram glows behind two chibi cartoon newlyweds in silk and gold, rangoli on the stone floor, diyas everywhere, marigold garlands on the pillars.',
