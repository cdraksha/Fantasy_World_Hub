...
import useIndianCitiesContent from '../hooks/useIndianCitiesContent';

export default function IndianCitiesExperience({ onStop }) {
  const { generateContent, isGenerating, error } = useIndianCitiesContent();
    ...
    <div style={{
      ...
      <button
        ...
        style={{
          ...
          background: 'none', border: '1px solid rgba(255,180,80,0.35)',
          color: 'rgba(255,180,80,0.7)', padding: '7px 18px',
  ...
  if (isGenerating) {
    ...
    return (
      <Shell>
        <div style={{ textAlign: 'center', color: 'rgba(255,180,80,0.8)' }}>
          <div style={{
            width: 72, height: 72,
            border: '3px solid rgba(255,160,60,0.15)',
            borderTop: '3px solid rgba(255,160,60,0.95)',
          ...
          <div style={{ position: 'relative', width: 120, height: 120, margin: '0 auto 18px' }}>
            <svg width="120" height="120" style={{ position: 'absolute', inset: 0, transform: 'rotate(-90deg)' }}>
              <circle cx="60" cy="60" r="52" fill="none" stroke="rgba(255,160,60,0.1)" strokeWidth="4" />
              <circle
                cx="60" cy="60" r="52" fill="none"
                stroke={urgent ? 'rgba(255,80,60,0.9)' : 'rgba(255,160,60,0.85)'}
                strokeWidth="4"
    ...
    <Shell>
      <div style={{ textAlign: 'center', color: 'rgba(255,80,80,0.8)', maxWidth: 400 }}>
        ...
        <button onClick={load} style={{
          background: 'none', border: '1px solid rgba(255,180,80,0.5)',
          color: 'rgba(255,180,80,0.85)', padding: '10px 28px',
    ...
    <Shell>
      ...
      <button
        ...
        style={{
          ...
          background: 'rgba(0,0,0,0.55)', border: '1px solid rgba(255,180,80,0.4)',
          color: 'rgba(255,180,80,0.85)', width: 48, height: 48,
          borderRadius: 10, cursor: 'pointer', display: 'flex',
          alignItems: 'center', justifyContent: 'center',
          backdropFilter: 'blur(8px)', transition: 'all 0.2s'
        }}
        onMouseEnter={e => { e.currentTarget.style.background = 'rgba(255,140,0,0.25)'; e.currentTarget.style.borderColor = 'rgba(255,180,80,0.9)'; e.currentTarget.style.color = '#fff'; }}
        onMouseLeave={e => { e.currentTarget.style.background = 'rgba(0,0,0,0.55)'; e.currentTarget.style.borderColor = 'rgba(255,180,80,0.4)'; e.currentTarget.style.color = 'rgba(255,180,80,0.85)'; }}
      >
      ...
      <div style={{
        ...
        <button
          ...
          style={{
            background: 'none', border: '1px solid rgba(255,180,80,0.5)',
            color: 'rgba(255,180,80,0.9)', padding: '13px 44px',
