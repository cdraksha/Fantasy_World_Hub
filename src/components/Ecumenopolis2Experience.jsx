...
import useEcumenopolis2Content from '../hooks/useEcumenopolis2Content';

export default function Ecumenopolis2Experience({ onStop }) {
  const { generateContent, isGenerating, error } = useEcumenopolis2Content();
    ...
    <Shell>
      ...
      <div style={{
        ...
        <div style={{
          ...
          textShadow: '0 2px 20px rgba(0,0,0,0.9), 0 0 50px rgba(60,120,255,0.45)',
      ...
      <button
        ...
        style={{
          ...
          background: 'rgba(0,0,0,0.55)', border: '1px solid rgba(120,180,255,0.4)',
          color: 'rgba(120,180,255,0.85)', width: 48, height: 48,
          borderRadius: 10, cursor: 'pointer', display: 'flex',
          alignItems: 'center', justifyContent: 'center',
          backdropFilter: 'blur(8px)', transition: 'all 0.2s'
        }}
        onMouseEnter={e => { e.currentTarget.style.background = 'rgba(40,80,200,0.28)'; e.currentTarget.style.borderColor = 'rgba(120,180,255,0.9)'; e.currentTarget.style.color = '#fff'; }}
        onMouseLeave={e => { e.currentTarget.style.background = 'rgba(0,0,0,0.55)'; e.currentTarget.style.borderColor = 'rgba(120,180,255,0.4)'; e.currentTarget.style.color = 'rgba(120,180,255,0.85)'; }}
      >
      ...
      <div style={{
        ...
        <button
          ...
          onMouseEnter={e => { e.currentTarget.style.borderColor = 'rgba(120,180,255,1)'; e.currentTarget.style.color = '#fff'; e.currentTarget.style.background = 'rgba(40,80,200,0.18)'; }}
